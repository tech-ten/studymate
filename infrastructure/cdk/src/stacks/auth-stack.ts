    ...
    this.userPoolClient = this.userPool.addClient('AgentsFormWebClient', {
      ...
      oAuth: {
        ...
        logoutUrls: [
          ...
          'https://grademychild.com.au/oauth-redirect',
          'https://www.grademychild.com.au',
          'https://www.grademychild.com.au/oauth-redirect',
          'https://tutor.agentsform.ai',
          'https://tutor.agentsform.ai/oauth-redirect',
          'https://agentsform.ai',
          'https://agentsform.ai/oauth-redirect',
        ],
      },
